        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-8 rounded-2xl shadow-soft border border-slate-100 flex items-center">
                    ...
                    <div>
                        <p className="text-sm font-semibold text-slate-400 uppercase tracking-widest">Projects</p>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-soft border border-slate-100 flex items-center">
                    ...
                    <div>
                        <p className="text-sm font-semibold text-slate-400 uppercase tracking-widest">Clients</p>
